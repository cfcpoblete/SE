...
<head>
	...
	<script language="javaScript" type="text/javascript" src="styles/js.js"></script>
	...
	{
		var x;
		var r=confirm("Confirm Transaction");
		if (r==true)
		  {
			x="Transaction sent";
		  }
							...
							for ($y=1;$y<4;$y++)
								...
								for ($z=1;$z<4;$z++)
									...
									$x= $x + 1;
										...
										echo 
										'<td><a href="S_ordering.php?prop_id='.$x.'" onclick="buy()" onMouseOver="show(\'item'.$x.'\')" onMouseOut="hide(\'item'.$x.'\')">
