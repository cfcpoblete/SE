<?php
	...
	if (isset($_REQUEST['btnSubmit']))
	{
  	...
  	if($_SESSION['encoded_captcha']!=md5($_POST['code'])) {
		$mess = "Security Code not entered correcty. ";
	}
	else if($templateClass->checkaccount($username))
	{
		...
		$templateClass->addAccount($usertype, $username, $password, $firstname, $middlename, $lastname, $email, $gender, $birthday);
...
<div id="content">
			...
			<div>&nbsp;</div>
			<?php if(!$success){?>
			<form id="from1" name="form1"method="post" action="register.php">
				<table width="500px">
					...
					<tr class="aodd">
						<td>
							...
							<div class="inputreg">
								<input type="text" name="username" id="username" tabindex="2" autocomplete="off" maxlength="32" size="20" style="width:150px" value="<?php echo isset($username) ? $username : "" ?>" />
							</div>
						</td>
					</tr>
					<tr class="aeven">
					...
					<tr class="aodd">
						<td>
							...
							<div class="inputreg">
								<a onClick="setYears(1947, 2012);showCalender(this, 'birthday');"><input type="text" name="birthday" id="birthday" value="<?php echo isset($birthday) ? $birthday : "" ?>" readonly tabindex="10" /></a>
					...
					<tr class="aeven">
						<td>
							<div class="labelreg"></div >
							<img src="plugins/captcha/advanced_captcha_script.php" /></div>
						</td>
					</tr>
					<tr class="aodd">
						<td>
							<div class="labelreg">Security Code:</div >
							<div class="inputreg">
								<input type="text" placeholder="Enter security code here" name="code" id="code" tabindex="11" autocomplete="off" maxlength="32" size="20"/>
							</div>
						</td>
					</tr>
					<tr>
					  <td>
						<div id="form1_errorloc" class="error_strings">
						</div>
					  </td>
					</tr>
					<tr>
